...
class Actor:
    ...
    def build_model(self):
        ...
        self.model = models.Model(inputs=states, outputs=scaled_actions)

        # Define loss function using action value (Q value) gradients
        action_gradients = layers.Input(shape=(self.action_size,))
        loss = K.mean(-action_gradients * scaled_actions)
...
class Critic:
    ...
    def build_model(self):
        ...
        self.model =models.Model(inputs=[states, self.actions], outputs=self.Q_values)
        ...
        action_gradients = K.gradients(self.Q_values, self.actions)
